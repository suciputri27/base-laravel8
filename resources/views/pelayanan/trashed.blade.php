                ...
                <tbody>
                    @forelse($pelayanan as $pelayanan)
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-success btn-sm" onclick="restoreCategory('{{ $pelayanan->encrypted_id }}')">
                                    <i class="fas fa-undo"></i> Pulihkan
                                </button>
                                <button type="button" class="btn btn-danger btn-sm" onclick="forceDeleteCategory('{{ $pelayanan->encrypted_id }}')">
